...
| --- | --- | --- | --- |
| 2026-06-08 20:47 | `804fb34` | fix(auth): ordered eviction for revocation blocklist + remove JTI echo | api/auth.py, tests/test_auth_revocation.py, tests/test_onboard_bridge_mavlink_tx.py |
