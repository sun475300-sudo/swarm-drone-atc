...
| --- | --- | --- | --- |
| 2026-06-10 03:10 | `1d6d419` | fix(raft): 단일 노드 replicate()/start() stale TODO 2건 청산 | README.md, ROADMAP.md, src/raft/airspace_controller_ha.py |
| 2026-06-10 00:00 | (pending) | fix(raft): 단일 노드 `replicate()`/`start()` stale TODO 2건 청산 — quorum-of-1 fast-path 명시, 멀티노드 합의는 `RaftCluster.propose()` 담당 (raft 36 pass). 일일 점검 GREEN, 중복 PR #212·#213 통합 | src/raft/airspace_controller_ha.py, README.md, ROADMAP.md |
