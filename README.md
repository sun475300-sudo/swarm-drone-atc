...
| --- | --- | --- | --- |
| 2026-06-03 22:28 | `b99de41` | fix: P732 리뷰 HIGH(식별자 충돌) + 해양 C9 스모크 플레이키 해소 | docs/simulator.html, docs/swarm_3d_simulator.html, swarm_3d_simulator.html, tests/e2e/smoke_maritime.mjs, tests/e2e/smoke_sim.mjs, visualization/swarm_3d_simulator.html |
| 2026-06-03 22:19 | `5bd50f9` | feat: P732(B2) 대규모 CPA 충돌예측 복원 — 공간 해시 O(N·k) | ROADMAP.md, docs/simulator.html, docs/swarm_3d_simulator.html, swarm_3d_simulator.html, tests/e2e/smoke_sim.mjs, visualization/swarm_3d_simulator.html |
