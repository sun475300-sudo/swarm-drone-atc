...
| --- | --- | --- | --- |
| 2026-06-26 12:19 | `c3b8fc0` | fix(deps): pydantic-core 2.47.0 → 2.46.4 — pydantic 2.13.4 호환 핀 복원 | requirements.lock.txt |
| 2026-06-26 12:15 | `c799c1e` | fix(genesis): Phase 323 어댑터 import 경계 검증 강화 (코드리뷰 반영) | simulation/external_sim_adapter.py, tests/test_external_sim_adapter.py |
