...
| --- | --- | --- | --- |
| 2026-06-13 17:11 | `759f2fa` | feat(plans): ODYSSEY 446 — 충돌 해결률 통계적 검정력 분석 | ROADMAP.md, docs/SIMULATOR_ODYSSEY_PLAN.md, simulation/resolution_rate_power.py, tests/test_resolution_rate_power.py |
