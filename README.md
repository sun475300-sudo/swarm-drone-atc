...
| Python 테스트 수집 | **9,591 collected · 수집 오류 0** (2026-07-21 실측, dash 4.1·plotly 6.9 lock 반영) |
...
| **Test Collection** | **9,591 tests** | Automated pytest collection across 1,118 Python files and 306 test files |
<div align="center">
...
| Full Python collection | **9,591 collected · 수집 오류 0** (2026-07-21 실측) |
