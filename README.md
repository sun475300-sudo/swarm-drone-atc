...
> **🆕 최신 업데이트 (2026-06-04 · HYPER Phase 11+14+15 통합 · 85/86 E2E)** — **🖼 시나리오 갤러리 모달**(5 카테고리: 추천·스트레스·기상·군용임무·도시UAM, 캔버스 썸네일 자동 생성, ESC/G 단축키), **🌐 4언어 i18n 순환**(KO → EN → JA → ZH → KO, HTML lang 동기), **🚢 해양 ATC 관제 콘솔**(HOLD/RTB/AVOID/SLOW/FAST/PORT/STBD/CLEAR + TTS + 비프), **🖥 데스크탑 v1.1 AppImage 105MB ASAR 검증**, 메인 3D **MEGA 9 Phase 통합**(ATC·TAC·CIN·CAM·MIS·INJ·ANA·AUD·MOB), **해양 PWA**, **CI 3-job**, **HYPER 플랜 Phase 10-50**, **96개 `_sdacs` API 자동 문서화**, **RELEASE_GUIDE**. Playwright E2E **85/86 통과** (1-9: 61 + 해양 PWA: 6 + 해양 ATC: 7 + 갤러리+i18n: 11), 회귀 **4,140/4,140 통과**. 🌌 HYPER: [`docs/SIMULATOR_HYPER_PLAN.md`](docs/SIMULATOR_HYPER_PLAN.md) · API: [`docs/SDACS_API.md`](docs/SDACS_API.md) · 릴리스: [`docs/RELEASE_GUIDE.md`](docs/RELEASE_GUIDE.md) · 마스터: [`docs/SIMULATOR_MEGA_PLAN.md`](docs/SIMULATOR_MEGA_PLAN.md)
>
...
| --- | --- | --- | --- |
| 2026-06-05 12:18 | `e64c338` | docs(api): _sdacs API 자동 문서 생성기 + 동기 검증 테스트 (HYPER Phase 10) | docs/SDACS_API.md, docs/SIMULATOR_HYPER_PLAN.md, scripts/gen_sdacs_api.py, tests/test_sdacs_api_doc.py |
