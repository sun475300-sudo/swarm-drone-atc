...
| --- | --- | --- | --- |
| 2026-06-14 10:14 | `8e386ed` | feat(genesis): Phase 303 비행계획 신고 양식 자동 생성 | CHANGELOG.md, docs/SIMULATOR_GENESIS_PLAN.md, scripts/generate_flight_plan.py, src/certification/__init__.py, src/certification/flight_plan.py, tests/test_certification_flight_plan.py |
