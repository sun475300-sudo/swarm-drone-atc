...
| --- | --- | --- | --- |
| 2026-06-05 03:32 | `19cfdbe` | feat(simulator): Phase 2 TAC-6 회피 의도선 (APF Vector Preview) | docs/SIMULATOR_PHASE_PLANS.md, docs/simulator.html, docs/swarm_3d_simulator.html, swarm_3d_simulator.html, tests/e2e/test_simulator_tac.py, visualization/swarm_3d_simulator.html |
