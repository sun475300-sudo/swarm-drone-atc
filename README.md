...
| --- | --- | --- | --- |
| 2026-06-04 23:20 | `3e8c8bd` | ci(simulator): Phase 10 — Phase 1-9 Playwright E2E 5종을 sim-smoke CI에 편입 | .github/workflows/sim-smoke.yml, docs/SIMULATOR_MEGA_PLAN.md |
