...
| --- | --- | --- | --- |
| 2026-06-14 08:10 | `1530ad1` | feat(genesis): Phase 342 전남 도서(신안·완도) 의료 배송 거점 DB | CHANGELOG.md, ROADMAP.md, src/applications/jeonnam_island_sites.py, tests/track_e/test_jeonnam_island_sites.py |
