...
| --- | --- | --- | --- |
| 2026-06-17 17:16 | `aaa9ef3` | feat(odyssey): Phase 469 정책 영향 시뮬레이션 — 규제 파라미터 변경 효과 자동 비교 | CHANGELOG.md, ROADMAP.md, docs/SIMULATOR_ODYSSEY_PLAN.md, simulation/policy_impact.py, tests/test_policy_impact.py |
