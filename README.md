...
| --- | --- | --- | --- |
| 2026-06-13 23:17 | `966c286` | fix(geo_zones): 자오선(lon=180) 존 60 wrap 버그 수정 + 테스트 9건 보강 | CHANGELOG.md, docs/SIMULATOR_ODYSSEY_PLAN.md, simulation/geo_zones.py, tests/test_geo_zones.py |
| 2026-06-13 23:14 | `5744075` | feat(plans): ODYSSEY 401·406 — EASA U-space 매핑 + 다국 좌표계 UTM 존 판정 | CHANGELOG.md, docs/SIMULATOR_ODYSSEY_PLAN.md, docs/certification/EASA_USPACE_MAPPING.md, simulation/geo_zones.py, tests/test_geo_zones.py |
