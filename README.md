...
| --- | --- | --- | --- |
| 2026-05-29 11:49 | `dcc260a` | feat: P712/P713/P717/P719 — JWT RBAC, 1kHz WS push, load test, security audit | ROADMAP.md, api/auth.py, api/fastapi_server.py, scripts/load_test.py, scripts/security_audit.py, tests/test_api_auth.py |
