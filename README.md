...
| --- | --- | --- | --- |
| 2026-06-04 02:19 | `f0d0a94` | fix: P711 프론트엔드 code-reviewer 지적 반영 (HIGH 4건) | frontend/src/api/client.ts, frontend/src/components/RunPanel.tsx, frontend/src/hooks/useTelemetry.ts |
