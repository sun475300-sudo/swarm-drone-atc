...
| --- | --- | --- | --- |
| 2026-06-14 18:09 | `887cef0` | feat(genesis): Phase 304 KC 전파인증 요건 체크리스트 (통신 모듈별) | docs/SIMULATOR_GENESIS_PLAN.md, simulation/kc_radio_certification.py, tests/test_kc_radio_certification.py |
