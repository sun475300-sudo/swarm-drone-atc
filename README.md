...
| --- | --- | --- | --- |
| 2026-06-15 21:20 | `0376021` | fix(odyssey): Phase 425 code-reviewer 반영 — 버전 다운그레이드 가드·origin 소유권 영구화·인박스 정리 | CHANGELOG.md, ROADMAP.md, docs/SIMULATOR_ODYSSEY_PLAN.md, simulation/federation_notam.py, tests/test_federation_notam.py |
| 2026-06-15 21:16 | `04e1e1b` | feat(odyssey): Phase 425 연합 NOTAM 전파 — 동적 NFZ 인접 인스턴스 결정적 브로드캐스트 | CHANGELOG.md, ROADMAP.md, docs/SIMULATOR_ODYSSEY_PLAN.md, simulation/federation_notam.py, tests/test_federation_notam.py |
