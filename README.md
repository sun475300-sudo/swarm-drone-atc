...
| --- | --- | --- | --- |
| 2026-05-31 02:17 | `5decb8b` | feat: ROADMAP 실태 반영 + 일일 상태 자동화 스크립트 | ROADMAP.md, docs/paper/EVALUATION_METRICS.md, reports/status_2026-05-30.md, scripts/sdacs_daily_status.py, tests/test_sdacs_daily_status.py |
