...
| --- | --- | --- | --- |
| 2026-06-19 14:10 | `a566e4e` | feat(odyssey): Phase 409 다국 BVLOS 규제 비교 (한·미·EU·일) — 일일 점검 2026-06-19 | docs/SIMULATOR_ODYSSEY_PLAN.md, docs/certification/BVLOS_REGULATION_COMPARISON.md, simulation/bvlos_regulation_compare.py, tests/test_bvlos_regulation_compare.py |
