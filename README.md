...
| 날짜 | 시간 | 주요 변경 사항 | 커밋 |
|------|------|---------------|------|
| 2026-03-26 | 21:00 KST | APF 충돌회피 대폭 개선(수직분리·누적반발력), ATC 9대 CPA 능동관제, 동적기상 시스템 | — |
