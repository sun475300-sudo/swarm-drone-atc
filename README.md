...
| --- | --- | --- | --- |
| 2026-06-05 01:22 | `379f202` | feat(simulator): ANA-6 드론별 텔레메트리 CSV — 미구현 중단 하위항목 완성 | docs/SIMULATOR_PHASE_PLANS.md, docs/simulator.html, docs/swarm_3d_simulator.html, swarm_3d_simulator.html, tests/e2e/test_simulator_mis_ana_mob.py, visualization/swarm_3d_simulator.html |
