...
| --- | --- | --- | --- |
| 2026-06-10 16:12 | `afe7ff3` | fix(raft): airspace_controller_ha stale TODO 2건 청산 + 일일 점검 2026-06-10 | README.md, ROADMAP.md, src/raft/airspace_controller_ha.py |
| 2026-06-10 | (pending) | fix(raft): airspace_controller_ha stale TODO 2건 청산 → cluster.py 위임 주석 + 일일 점검 2026-06-10 (소스 실 TODO 0건) | README.md, ROADMAP.md, src/raft/airspace_controller_ha.py |
