...
| --- | --- | --- | --- |
| 2026-06-20 07:24 | `0225432` | feat(odyssey): Phase 482 브라우저 API 폐기 감시 정책 (신규) + 적체 드래프트 #389 일원화 | README.md, ROADMAP.md, docs/SIMULATOR_ODYSSEY_PLAN.md, docs/standards/BROWSER_API_DEPRECATION_WATCH.md, simulation/browser_api_watch.py, tests/test_browser_api_watch.py |
