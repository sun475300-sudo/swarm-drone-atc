...
| --- | --- | --- | --- |
| 2026-06-13 16:16 | `08d3c0d` | fix(genesis): Phase 303 코드 리뷰 반영 — BVLOS·대수·경로·기하 정정 | scripts/generate_flight_plan.py, tests/test_flight_plan_form.py |
| 2026-06-13 16:13 | `b68fb23` | feat(genesis): Phase 303 비행승인 신청서(Drone One-Stop) 자동 생성 | .gitignore, CHANGELOG.md, ROADMAP.md, docs/SIMULATOR_GENESIS_PLAN.md, docs/certification/AIR_SAFETY_ACT_MATRIX.md, docs/certification/FLIGHT_PLAN_FORM.md … |
