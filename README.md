...
| --- | --- | --- | --- |
| 2026-07-02 12:22 | `40b73df` | fix(ci): Electron LTS 스냅샷 42→43 갱신 — 리포 핀 ^43.0.0 정합 (CI RED 회복) | docs/standards/ELECTRON_LTS_TRACKING_POLICY.md, simulation/electron_lts_policy.py, tests/test_electron_lts_policy.py |
...
| 2026-06-26 16:20 | `a0c559b` | fix(genesis): Phase 323 어댑터 외부입력 경계 검증 강화 (advisor HIGH 2건 반영) | ROADMAP.md, docs/SIMULATOR_GENESIS_PLAN.md, simulation/external_sim_adapter.py, tests/test_external_sim_adapter.py |
