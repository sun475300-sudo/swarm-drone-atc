...
| --- | --- | --- | --- |
| 2026-06-13 20:20 | `9aa2d24` | feat(genesis): Phase 303 비행계획 신고 양식 + 307 항철위 사고 보고 양식 자동 생성 | CHANGELOG.md, docs/SIMULATOR_GENESIS_PLAN.md, docs/certification/ACCIDENT_REPORT_ARAIB.md, docs/certification/AIR_SAFETY_ACT_MATRIX.md, docs/certification/FLIGHT_PLAN_SUBMISSION.md, src/certification/__init__.py … |
