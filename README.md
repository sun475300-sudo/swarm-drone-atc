...
| --- | --- | --- | --- |
| 2026-06-04 00:35 | `3f177a3` | test: C9 해양 검증 기록 스모크 플래키 안정화 (폴링 기반) | tests/e2e/smoke_maritime.mjs |
| 2026-06-04 00:27 | `793c2d2` | feat: P733 ws_bridge 실데이터 데모↔실측 토글 + 라이브 스냅샷 적용 | ROADMAP.md, docs/simulator.html, docs/swarm_3d_simulator.html, swarm_3d_simulator.html, tests/e2e/smoke_sim.mjs, visualization/swarm_3d_simulator.html |
