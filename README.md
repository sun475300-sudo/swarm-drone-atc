...
| --- | --- | --- | --- |
| 2026-06-26 10:22 | `60291ea` | fix(deps): pydantic-core 2.47.0→2.46.4 — pydantic 2.13.4 호환 핀 정합 (CI canonical-hash 복구) | requirements.lock.txt |
| 2026-06-26 10:20 | `9a8163b` | feat(genesis): Phase 323 외부 시뮬레이터 어댑터 (BlueSky/U-TRAFMAN import/export) | ROADMAP.md, docs/SIMULATOR_GENESIS_PLAN.md, docs/standards/EXTERNAL_SIM_ADAPTER.md, simulation/external_sim_adapter.py, tests/test_external_sim_adapter.py |
