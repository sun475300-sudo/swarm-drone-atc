...
| 이벤트 기록 | 실시간 이벤트 로그 — 💥충돌/⚠️근접/↪️회피/📡어드바이저리/📵통신두절/🔴장애 |
| 편대 추적기 | 우측 패널 — 드론별 고도/속도/배터리 실시간 모니터링 |
| ATC 관제 드론 | 5대 고정 관제 드론 — 레이더 범위 시각화, 회전 애니메이션 |
| 바람/ROGUE | 기상교란 시 바람 효과, 침입드론 빨간 트레일 |
