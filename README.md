...
| --- | --- | --- | --- |
| 2026-06-14 06:09 | `b6d2ec8` | feat(genesis): Phase 322 .sdacs-scenario 스키마 + 검증기 | CHANGELOG.md, docs/SIMULATOR_GENESIS_PLAN.md, docs/schemas/sdacs-scenario.schema.json, simulation/scenario_schema.py, tests/test_scenario_schema.py |
