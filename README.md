...
| --- | --- | --- | --- |
| 2026-06-01 03:43 | `22d5388` | fix: suppress pre-existing numpy 2.x mypy errors in sensor_fusion and boids_swarm | pyproject.toml |
| 2026-06-01 03:17 | `5c71272` | fix: resolve Python 3.10 CI failures — cryptography dep + prometheus idempotency | api/fastapi_server.py, pyproject.toml |
