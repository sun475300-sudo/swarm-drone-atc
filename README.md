...
| --- | --- | --- | --- |
| 2026-06-14 02:15 | `1e65e0e` | feat(genesis): Phase 303 비행계획 신고 양식 자동 생성 (Drone One-Stop) | CHANGELOG.md, docs/SIMULATOR_GENESIS_PLAN.md, docs/certification/AIR_SAFETY_ACT_MATRIX.md, src/compliance/__init__.py, src/compliance/flight_plan_filing.py, tests/test_genesis303_flight_plan_filing.py |
