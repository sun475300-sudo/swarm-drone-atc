...
| --- | --- | --- | --- |
| 2026-06-14 16:08 | `220be46` | feat(genesis): Phase 307 사고 보고 양식 자동 작성 (ARAIB 표준) | CHANGELOG.md, docs/SIMULATOR_GENESIS_PLAN.md, docs/certification/INCIDENT_REPORT.md, simulation/incident_report.py, tests/test_incident_report.py |
