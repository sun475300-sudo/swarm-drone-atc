...
| --- | --- | --- | --- |
| 2026-06-06 16:21 | `6a659ce` | feat: P711 React 대시보드 MVP (frontend/) — FastAPI 백엔드 소비 | CHANGELOG.md, ROADMAP.md, STATUS_REPORT.md, frontend/.env.example, frontend/.gitignore, frontend/README.md … |
