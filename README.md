...
| --- | --- | --- | --- |
| 2026-06-25 01:31 | `47adcae` | ci: fix mypy shape-typing error in hybrid_collision_avoidance (rl_force) | src/autonomy/hybrid_collision_avoidance.py |
| 2026-06-25 01:18 | `b24e1cc` | feat(odyssey): Phase 452 — RL 일반화(미학습 시나리오 전이) 평가 프로토콜 적합성 게이트 | CHANGELOG.md, ROADMAP.md, docs/SIMULATOR_ODYSSEY_PLAN.md, docs/standards/RL_GENERALIZATION_PROTOCOL.md, simulation/rl_generalization_protocol.py, tests/test_rl_generalization_protocol.py |
