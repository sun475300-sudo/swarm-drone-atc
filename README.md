...
| --- | --- | --- | --- |
| 2026-06-14 05:08 | `65926b2` | feat(certification): GENESIS Phase 303 비행계획 신고 양식 자동 생성 | CHANGELOG.md, ROADMAP.md, src/certification/__init__.py, src/certification/flight_plan_declaration.py, tests/certification/__init__.py, tests/certification/test_flight_plan_declaration.py |
