...
| --- | --- | --- | --- |
| 2026-06-25 04:26 | `0db5019` | ci: fix mypy ndarray shape-type error in hybrid_collision_avoidance | src/autonomy/hybrid_collision_avoidance.py |
| 2026-06-25 04:15 | `48f8681` | feat(odyssey): Phase 405 — 국제 벤치마크 비교 (SDACS·BlueSky·U-TRAFMAN) | CHANGELOG.md, docs/SIMULATOR_ODYSSEY_PLAN.md, docs/standards/INTERNATIONAL_BENCHMARK_COMPARISON.md, simulation/benchmark_comparison.py, tests/test_benchmark_comparison.py |
