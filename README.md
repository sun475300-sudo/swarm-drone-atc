...
| --- | --- | --- | --- |
| 2026-06-08 00:19 | `0c99f15` | docs: 변경 이력 업데이트 — simulate --output CI 복구 | README.md |
| 2026-06-08 00:35 | `a3f84a3` | fix(cli): simulate에 --output JSON 추가 — 나이틀리 벤치마크 CI RED 복구 (+회귀 테스트) | main.py, tests/test_main_cli.py |
