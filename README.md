...
| --- | --- | --- | --- |
| 2026-06-14 04:17 | `3686a1a` | fix(docs): SDACS_API·sdacs.d.ts 408 API 정합 (flightPlanExport 반영) | docs/SDACS_API.md, docs/sdacs.d.ts |
| 2026-06-14 04:11 | `fecc63f` | feat(genesis): Phase 303 비행계획 신고 양식 자동 생성 (Drone One-Stop) | README.md, docs/SIMULATOR_GENESIS_PLAN.md, docs/simulator.html, docs/swarm_3d_simulator.html, swarm_3d_simulator.html, tests/e2e/test_simulator_genesis_303.py … |
