...
- [x] **Phase 402a** 🌏 FAA UTM ConOps v2 USS 역할 갭 분석 — `simulation/faa_utm_gap.py` + `docs/certification/FAA_UTM_GAP_ANALYSIS.md` 21개 USS 요구사항(8 카테고리), 9 full·11 partial·1 gap = 69.05% 준수율, frozen dataclass + MappingProxyType, CLI(--report/--gaps/--json/--category), 42건 PASS (2026-06-20)
- [x] **Phase 402b** 🌏 FAA UTM ConOps v2.0 USS 역할 적합성 매트릭스 — `simulation/faa_uss_roles.py` USS 역할 17종↔SDACS 모듈 결정적 적합성 매트릭스(핵심 7/7·전체 15/17, 운영자 자격·공공안전 접근 갭 정직 표면화, 인용 모듈 디스크 실재 강제), 46건 PASS (2026-06-18)
