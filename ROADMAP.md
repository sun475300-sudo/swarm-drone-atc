...
- [x] **Phase 445** 🔬 불확실성 정량화 — `simulation/monte_carlo.py` `compute_confidence_intervals`/`confidence_interval_report` (Student-t 신뢰구간) + `monte-carlo --ci` CLI (2026-06-13)
- [ ] **Phase 441-444·446·449-460** 🔬 Formal & Research Frontier — TLA+ 안전망 명세·모델 체킹
