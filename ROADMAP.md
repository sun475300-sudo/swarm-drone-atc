...
- [~] **P711** — FastAPI 백엔드 완성 (`api/fastapi_server.py` 769줄, 전체 엔드포인트 구현) + React 프론트엔드 MVP (`frontend/` Vite+TS — 시나리오 목록·실행·폴링·WS 텔레메트리, build·vitest 통과, 2026-06-03) — 풀 SaaS UI(3D 뷰·인증 흐름) 잔여
