...
*Last updated: 2026-06-04 — Track D 웹 시뮬레이터: P729(대규모 모드 로터 InstancedMesh 확장 — 단일 추가 draw call·드론 수 무관·시간 기반 회전, 헤드리스 스모크 통과) 완료. P730~P735 진행 예정. 이전: Track C P714·P715·P718·P719 완료, P720 진행 예정 / Track D P721~P728 완료. 테스트 3,830+개.*
