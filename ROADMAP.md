...
- [x] **P732** — 대규모 CPA 충돌예측 복원(B2, 공간 해시) — `updateConflictViz`를 O(N²)+400대 컷오프에서 물리 루프와 동일한 공간 해시(3×3 셀, O(N·k))로 교체, 1k+ 환경에서도 가장 임박한 쌍 우선 시각화. `_sdacs.conflictPairs` API + 헤드리스 스모크(1000대) 추가 (2026-06-03)
