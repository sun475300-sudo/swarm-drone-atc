...
- [x] **P729** — 대규모 모드 글로우 InstancedMesh 확장(B3) — `glowInst` 추가, body와 동일 변환·색, draw call +1만 증가, 스모크 14/14 (2026-06-03)
- [~] **P730** — UI 국제화(B5, KO/EN 토글) — 정적 35항목 + 동적 텍스트(로그 6종·트랙행·상세패널·선종 라벨) i18n 완료, 스모크 19/19 (2026-06-03). 모바일·터치 대응은 잔여
