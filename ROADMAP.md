...
- [x] **Phase 402** 🌏 FAA UTM ConOps v2.0 정렬 — `simulation/faa_utm_conops.py` USS/FIMS/SDSP/OPERATOR 역할 요건 15종 ↔ SDACS 결정적 매핑 + FIMS 게이트웨이 정직 갭 표면화(전체 14/15·핵심 8/9), 39건 PASS (2026-06-18)
- [ ] **Phase 403-405·407·409-420** 🌏 Global Expansion — EASA U-space·SORA·EN 완역·벤치마크 제출
