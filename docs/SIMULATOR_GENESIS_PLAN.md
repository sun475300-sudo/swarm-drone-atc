...
- **Phase 303** ✅ 비행계획 신고 양식 자동 생성 — `src/certification/flight_plan_submission.py` (Drone One-Stop 신청서, 고도>150m·야간/BVLOS·중량>25kg 승인 요건 결정적 판정, 14 테스트) (2026-06-13)
...
- **Phase 307** ✅ 사고 보고 양식 (항철위 표준) 자동 작성 — `src/certification/accident_report.py` (시뮬 사고 로그 → ARAIB 양식, 사고/준사고/경미 심각도 분류 + 즉시보고 의무 판정, 18 테스트) (2026-06-13)
