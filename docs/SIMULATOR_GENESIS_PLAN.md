...
- **Phase 303** ✅ 비행계획 신고 양식 자동 생성 — `src/certification/flight_plan.py` (드론 원스톱 비행승인·특별비행승인 신청서, 항공안전법 §127·시행규칙 §308·§309 승인 판정, `scripts/generate_flight_plan.py` export, 18 테스트) (2026-06-14)
