...
- **Phase 307** ✅ 사고 보고 양식 (항철위/ARAIB 표준) 자동 작성 — `simulation/incident_report.py` (시뮬 사고 로그 → 사고/준사고/항공안전장애 등급 결정적 분류·의무보고 시한 판정·로그 집계·JSON/텍스트 export, 19건 PASS) (2026-06-14)
