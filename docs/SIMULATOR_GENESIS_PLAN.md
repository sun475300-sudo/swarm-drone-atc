...
- **Phase 304** ✅ KC 전파인증 요건 체크리스트 — `simulation/kc_radio_certification.py` (통신 모듈별 적합성평가 종류[적합인증/적합등록/잠정인증] 결정적 분류·국내 소출력 대역/EIRP 적합성 판정·구비서류 산출·JSON/텍스트 export, 24건 PASS) (2026-06-14)
