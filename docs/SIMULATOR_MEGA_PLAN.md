...
| **2** | **TAC** 전술 시각화 | ▶ **즉시 시작** | ~700 | 10 | P1 |
| 3 | CIN 시네마틱 | 후속 | ~600 | 8 | P2 |
| 4 | CAM 카메라 모드 | 후속 | ~450 | 6 | P2 |
| 5 | MIS 임무 계획 UI | 후속 | ~800 | 8 | P3 |
...
- [x] `_sdacs` API 전체 문서화 (`docs/SDACS_API.md`) — `_sdacs`(9 Phase) + `_mds`(해양) 전체 멤버 레퍼런스 (2026-06-04)
- [x] E2E 테스트 통합 매트릭스 (`.github/workflows/sim-smoke.yml`)
- [ ] 데모 영상 녹화 (Phase 3 CIN 녹화 기능 사용, 2분) — 사용자 브라우저 환경
- [x] 라이브 데모 GitHub Pages 동기화
