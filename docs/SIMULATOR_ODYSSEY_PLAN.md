...
- **Phase 445** ✅ 불확실성 정량화 — Monte Carlo 신뢰구간 자동 리포트 (`simulation/monte_carlo.py` Student-t 기반 `compute_confidence_intervals`/`confidence_interval_report` + `monte-carlo --ci` CLI, 2026-06-13)
