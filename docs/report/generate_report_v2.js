...
children.push(makeTable(
  ...
  [
    ...
    ["테스트 스위트", "pytest", "255개 (22 모듈)", "단위/통합/시나리오 테스트"],
...
children.push(makeTable(
  ...
  [
    ...
    ["테스트 프레임워크", "pytest 7.4+ (255개 테스트, 22 모듈)"],
...
children.push(makeTable(
  ...
  [
    ...
    ["Phase 4: 검증", "2026.03 (3주차)", "pytest 255개, MC 38,400회, 코드리뷰 25건 수정", "테스트 리포트"],
...
children.push(p("22개 모듈에 걸쳐 255개의 자동화된 테스트를 구축하였다. 단위 테스트(APF, CPA, RA 등), 통합 테스트(시뮬레이터 E2E), 시나리오 테스트(8개 시나리오 자동 실행)를 포함한다. GitHub Actions CI를 통해 모든 커밋에 자동 테스트가 실행된다."));
