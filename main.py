...
def cmd_simulate(args: argparse.Namespace) -> None:
    ...
    # 결과 JSON 저장 (나이틀리 벤치마크 CI 등에서 사용)
    ...
    if output_path:
        ...
        payload.update({
            ...
            "real_time_factor": round(duration / elapsed, 2) if elapsed > 0 else None,
...
def main() -> None:
    ...
    p_sim.add_argument("--output",   default=None, help="결과 KPI를 JSON 파일로 저장 (없으면 출력만)")
